...
class BaseAviary_TestFlytoWall(gym.Env):
    ...
    def __init__(
        ...
        if self.GUI:
            ...
            p.resetDebugVisualizerCamera(cameraDistance=5, cameraYaw=-90, cameraPitch=-60, cameraTargetPosition=[0, 0, 0], physicsClientId=self.CLIENT)
    ...
    def _getDroneStateVector(self, nth_drone):
        ...
        ndarray
            ...
            - 5x previous raycast readings (front, back, left, right, top) [16:21] -> 0 bis 4
            - 5x actual raycast readings (front, back, left, right, top) [21:26] -> 0 bis 4
