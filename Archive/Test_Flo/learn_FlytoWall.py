...
def run(
    ...
    if DEFAULT_USE_PRETRAINED_MODEL and os.path.exists(DEFAULT_PRETRAINED_MODEL_PATH):
        ...
        model = PPO(
            ...
            train_env,
            verbose=1,
            learning_rate=0.0002,  # 0,0002 zu gering -> auf 0.0004 erhöht -> auf 0.0005 erhöht --> auf 0.0004 reduziert, da die Policy zu stark angepasst wurde, obwohl es schon 5s am Ziel war..
        )
    ...
    test_env = BaseRLAviary_TestFlytoWall(gui=gui_Test, act=DEFAULT_ACT, record=record_video)
