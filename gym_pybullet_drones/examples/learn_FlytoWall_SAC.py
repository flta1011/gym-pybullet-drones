...
from gym_pybullet_drones.examples.Test_Flo.BaseRLAviary_TestFlytoWall_SAC import BaseRLAviary_TestFlytoWall_SAC
...
def run(multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO, local=True):
    ...
    if not os.path.exists(filename):
        ...
        BaseRLAviary_TestFlytoWall_SAC,
        env_kwargs=dict(
        ...
        eval_env = BaseRLAviary_TestFlytoWall_SAC(
        drone_model=DroneModel("cf2x"),
        initial_xyzs=INIT_XYZS,
        initial_rpys=INIT_RPYS,
        gui=True,
    ...
    test_env = BaseRLAviary_TestFlytoWall_SAC(gui=gui,
                            act=DEFAULT_ACT,
                            record=record_video)
    test_env_nogui = BaseRLAviary_TestFlytoWall_SAC(act=DEFAULT_ACT)
