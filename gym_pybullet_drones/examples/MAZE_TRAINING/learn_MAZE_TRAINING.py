...
"""MODEL_Versionen: 
- M1:   PPO
- M2:   DQN_CNNPolicy_StandardFeatureExtractor          (hier nicht nutzbar!)
- M3:   DQN_MLPPolicy 
- M4:   DQN_CNNPolicy_CustomFeatureExtractor            (hier nicht nutzbar!)
- M5:   DQN_NN_MultiInputPolicy mit fullyConnectLayer   (hier nicht nutzbar!)
- M6:   SAC
"""
MODEL_VERSION = "M3"

"""REWARD_VERSIONen: siehe BaseAviary_MAZE_TRAINING.py für Details
- REWARD_VERSION_1: neuste Version: Belohnung für neuerkundung einer neuen Fläche, Bestrafung für näher an der Wand, Bestrafung für jeden Timestep
"""
REWARD_VERSION = "REWARD_VERSION_1"

"""O5: X,Y, Yaw, 4x Sensoren, X mal Last actions
"""
OBSERVATION_TYPE = "O5"
