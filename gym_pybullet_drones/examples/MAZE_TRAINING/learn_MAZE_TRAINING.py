...
from gym_pybullet_drones.examples.MAZE_TRAINING.BaseRLAviary_MAZE_TRAINING import (
...
DEFAULT_EPISODE_LEN_SEC = 0.5  # 15 * 60  # normal: 10*60 , aber 5 für Debugging
...
def run(
    ...
    test_env = BaseRLAviary_MAZE_TRAINING(gui=gui_Test, act=DEFAULT_ACT, record=record_video)
