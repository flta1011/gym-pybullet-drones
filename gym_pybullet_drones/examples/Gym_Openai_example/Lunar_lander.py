...
class LunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        # state[4]: Der Winkel des Landers.
        # state[5]: Die Winkelgeschwindigkeit des Landers, normalisiert auf den Bereich [-1, 1].
        # state[6]: Bodenkontakt des linken Beins (1.0, wenn es den Boden berührt, sonst 0.0).
        # state[7]: Bodenkontakt des rechten Beins (1.0, wenn es den Boden berührt, sonst 0.0).
        state = [
        ...
        assert len(state) == 8
        # shaping: Eine Funktion, die die Belohnung basierend auf dem Zustand des Landers berechnet:
        # Bestraft die Entfernung zur Mitte des Bildschirms und zur Helipad-Höhe.
        # Bestraft die Geschwindigkeit.
        # Bestraft den Winkel des Landers.
        # Belohnt den Bodenkontakt der Beine.
        # reward: Die Belohnung wird als Differenz zwischen dem aktuellen und dem vorherigen shaping-Wert berechnet.
