...
class LEDTimingsDriverMemory(MemoryElement):
    ...
    def __init__(self, id, type, size, mem_handler):
        super(LEDTimingsDriverMemory, self).__init__(id=id, type=type, size=size, mem_handler=mem_handler)
    ...
    def add(self, time, rgb, leds=0, fade=False, rotate=0):
        self.timings.append({"time": time, "rgb": rgb, "leds": leds, "fade": fade, "rotate": rotate})
