...
class TestPositionHlCommander(unittest.TestCase):
    ...
    def test_that_controller_is_selected_on_creation(self, sleep_mock):
        ...
        # Test
        PositionHlCommander(self.cf_mock, controller=PositionHlCommander.CONTROLLER_MELLINGER)

        # Assert
        self.param_mock.set_value.assert_has_calls([call("stabilizer.controller", "2")])
    ...
    def test_that_take_off_raises_exception_when_already_flying(self, sleep_mock):
        # Fixture
        self.sut.take_off()
    ...
    def test_that_it_goes_down_to_set_landing_height_on_landing(self, sleep_mock):
        # Fixture
    ...
    def test_that_it_goes_to_position(self, sleep_mock):
        ...
        self.commander_mock.go_to.assert_called_with(1.0, 2.0, 3.0, 0.0, duration)
        sleep_mock.assert_called_with(duration)

    def test_that_it_does_not_send_goto_to_same_position(self, sleep_mock):
        # Fixture
        self.sut.take_off()
        initial_pos = self.sut.get_position()
    ...
    def test_that_it_moves_distance(self, sleep_mock):
        ...
        duration = distance / 4.0
        final_pos = (initial_pos[0] + 1.0, initial_pos[1] + 2.0, initial_pos[2] + 3.0)
        self.commander_mock.go_to.assert_called_with(final_pos[0], final_pos[1], final_pos[2], 0.0, duration)
        sleep_mock.assert_called_with(duration)
    ...
    def test_that_it_goes_forward(self, sleep_mock):
        ...
        # Assert
        duration = 1.0 / 2.0
        final_pos = (initial_pos[0] + 1.0, initial_pos[1], initial_pos[2])
        self.commander_mock.go_to.assert_called_with(final_pos[0], final_pos[1], final_pos[2], 0.0, duration)
        sleep_mock.assert_called_with(duration)
    ...
    def test_that_it_goes_left(self, sleep_mock):
        ...
        # Assert
        duration = 1.0 / 2.0
        final_pos = (initial_pos[0], initial_pos[1] + 1.0, initial_pos[2])
        self.commander_mock.go_to.assert_called_with(final_pos[0], final_pos[1], final_pos[2], 0.0, duration)
        sleep_mock.assert_called_with(duration)
    ...
    def test_that_it_goes_right(self, sleep_mock):
        ...
        # Assert
        duration = 1.0 / 2.0
        final_pos = (initial_pos[0], initial_pos[1] - 1, initial_pos[2])
        self.commander_mock.go_to.assert_called_with(final_pos[0], final_pos[1], final_pos[2], 0, duration)
        sleep_mock.assert_called_with(duration)
    ...
    def test_that_it_goes_up(self, sleep_mock):
        ...
        # Assert
        duration = 1.0 / 2.0
        final_pos = (initial_pos[0], initial_pos[1], initial_pos[2] + 1)
        self.commander_mock.go_to.assert_called_with(final_pos[0], final_pos[1], final_pos[2], 0, duration)
        sleep_mock.assert_called_with(duration)
    ...
    def test_that_default_height_is_used(self, sleep_mock):
        ...
        duration = distance / 7.0
        self.commander_mock.go_to.assert_called_with(1.0, 2.0, 5.0, 0.0, duration)
        sleep_mock.assert_called_with(duration)
