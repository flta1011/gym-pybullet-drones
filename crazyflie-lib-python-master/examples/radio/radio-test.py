...
parser.add_argument("-try", "--try", dest="TRY", type=int, default=100, help="the time to send data for each channel")
# by default my crazyflie uses channel 80
parser.add_argument("-channel", "--channel", dest="channel", type=int, default=80, help="the default channel in crazyflie")
# by default my crazyflie uses datarate 2M
parser.add_argument("-rate", "--rate", dest="rate", type=int, default=2, help="the default datarate in crazyflie")
parser.add_argument("-frac", "--fraction", dest="fraction", type=float, default=0.25, help="top fraction of suggested channels")
